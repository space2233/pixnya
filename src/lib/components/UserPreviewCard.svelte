...
<style>
  ...
  .user-copy strong { font-size: var(--type-small); }
  .user-copy small { margin-top: 4px; color: var(--muted); font-size: var(--type-caption); }
  .user-heading i { color: var(--pixiv-blue); font-size: var(--type-caption); font-style: normal; font-weight: 700; }
  ...
  .preview-work button { position: absolute; z-index: 2; inset: 0; width: 100%; color: white; border: 0; background: rgba(20,24,28,.38); cursor: pointer; font-size: var(--type-body); font-weight: 700; }
  .no-preview { margin: 0; padding: 24px 14px; color: var(--muted); border-top: 1px solid var(--line); font-size: var(--type-caption); text-align: center; }
</style>
