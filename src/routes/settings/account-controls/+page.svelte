...
<AppShell title={m.account_controls_title()}>
  <main class="account-controls">
    ...
    <header class="page-heading">
      <h1>{m.account_controls_title()}</h1>
      <p>{m.account_controls_description()}</p>
    </header>
    ...
    {:else}
      ...
      <section class="card">
        ...
        <p>{m.account_controls_block_description()}</p>
      ...
      <section class="card">
        ...
        <p>{m.account_controls_mute_description()}</p>
      ...
      <section class="card local-only">
        ...
        <p>{m.account_controls_local_description()}</p>
      </section>
    {/if}
  </main>
</AppShell>
