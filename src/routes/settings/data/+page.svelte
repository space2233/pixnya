...
<style>
.page{width:min(760px,100%);box-sizing:border-box;margin:auto;padding:30px 24px 60px}h1{margin:24px 0;font-size:var(--type-title)}h2{margin:24px 4px 10px;color:var(--muted);font-size:var(--type-body)}section{overflow:hidden;border:1px solid var(--line);border-radius:18px;background:#fff}.row{display:flex;width:100%;min-height:62px;box-sizing:border-box;align-items:center;gap:12px;padding:0 18px;border:0;border-bottom:1px solid var(--line);background:#fff;color:var(--text);text-align:left;text-decoration:none}.row span{overflow:hidden;margin-left:auto;color:var(--muted);text-overflow:ellipsis;white-space:nowrap}.row i{color:#aeb4ba;font-size:var(--type-title);font-style:normal}.picker{cursor:pointer}input,select{margin-left:auto;accent-color:var(--pixiv-blue)}select{padding:8px;border:1px solid var(--line);border-radius:10px;background:#fff}.action{width:100%;min-height:54px;border:0;background:#fff;color:var(--pixiv-blue);font-weight:700}.danger{color:var(--danger)}.summary{display:flex;flex-wrap:wrap;gap:8px 18px;padding:14px 18px;border-bottom:1px solid var(--line);color:var(--muted);font-size:var(--type-body)}.failed{color:var(--danger)}.dialog-layer{position:fixed;z-index:1000;inset:0;display:grid;place-items:center;padding:20px}.scrim{position:absolute;inset:0;border:0;background:#0008}.dialog-layer>div{position:relative;width:min(420px,100%);box-sizing:border-box;padding:24px;border-radius:18px;background:#fff}.dialog-layer footer{display:flex;justify-content:flex-end;gap:10px}.dialog-layer footer button{padding:10px 18px;border:1px solid var(--line);border-radius:20px;background:#fff}.dialog-layer footer .primary{border-color:var(--pixiv-blue);background:var(--pixiv-blue);color:#fff}
</style>
