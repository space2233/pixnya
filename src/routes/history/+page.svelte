...
<style>
  ...
  .page-heading h1 { margin: 7px 0 0; font-size: var(--type-title); }
  .page-heading > button { display: flex; min-width: 110px; height: 38px; gap: 7px; align-items: center; justify-content: center; color: white; border: 0; border-radius: 19px; background: #27ae72; cursor: pointer; font-size: var(--type-body); font-weight: 700; }
  .page-heading > button.disabled { color: #6f7579; background: #e7e9eb; }
  .state { display: grid; min-height: 220px; margin-top: 22px; place-items: center; color: var(--muted); border: 1px dashed var(--line); border-radius: 12px; background: white; font-size: var(--type-small); }
  ...
  .toolbar input { min-width: 0; flex: 1; border: 0; outline: 0; background: transparent; font-size: var(--type-small); }
  .kind-filters { display: flex; gap: 4px; }
  .kind-filters button, .clear { height: 34px; padding: 0 12px; color: #686e72; border: 1px solid var(--line); border-radius: 17px; background: white; cursor: pointer; font-size: var(--type-body); }
  ...
  .notice, .paused { margin: 0; padding: 11px 16px; color: #55717f; border-bottom: 1px solid var(--line); background: #f2f9fd; font-size: var(--type-caption); }
  ...
  .thumbnail b { position: relative; z-index: 1; padding: 4px 6px; color: white; border-radius: 4px; background: rgba(25, 28, 30, .58); font-size: var(--type-caption); }
  .copy { min-width: 0; }
  .copy small, .copy strong, .copy em { display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
  .copy small { color: var(--pixiv-blue); font-size: var(--type-caption); font-weight: 700; }
  .copy strong { margin-top: 6px; font-size: var(--type-small); }
  .copy em { margin-top: 5px; color: var(--muted); font-size: var(--type-caption); font-style: normal; }
  ...
  @media (max-width: 680px) {
    ...
    .page-heading h1 { font-size: var(--type-section); }
