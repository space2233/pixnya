...
请前往 [PixNya v1.4.0 正式版](https://github.com/space2233/pixnya/releases/tag/v1.4.0)，按设备架构选择一个安装包：

- Windows x64：`PixNya_1.4.0_x64-setup.exe`
- Windows ARM64：`PixNya_1.4.0_arm64-setup.exe`
- Linux x64：`PixNya_1.4.0_amd64.AppImage`
- Android 10 及以上、ARM64：`pixnya-1.4.0-android-arm64-v8a.apk`
- Android 10 及以上、ARM32：`pixnya-1.4.0-android-armeabi-v7a.apk`

Release 中的 JSON 和签名文件供自动更新使用，普通用户无须下载。

当前公开稳定版为 `1.4.0`；当前源码版本为 `1.4.2`。
...
- 凭据无关的本地数据备份与迁移，可选包含离线资料并支持合并或替换恢复。
- 账号屏蔽、用户静音和标签静音管理。
