...
`1.5.0` 已是公开 latest stable；固定候选、五平台签名、10 个附件、匿名更新清单及三套签名均已复验。本轮不做人机活体验收。`1.4.4` 维护工作已完成并打 tag，但从未作为面向用户的 GitHub Release 公开，内容已包含在 `1.5.0` 中；未公开的 `1.4.4` Draft Release 已删除；历史 tag 因仓库不可删除 ruleset 保持原 SHA。
