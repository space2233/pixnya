...
> 状态：生产签名更新流程已投入使用；当前公开稳定版为 `1.4.0`，维护候选为 `1.4.2`
> 更新日期：2026-08-18
...
- [ ] 使用生产签名从公开 `1.4.0` 升级到 `1.4.2` Draft，完成 Windows x64 与 Android ARM64 的数据保留回归；Linux x64、Windows ARM64 与 Android ARM32 本轮只承诺签名 CI 构建。
